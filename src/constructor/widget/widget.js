 ...
 * @LastEditTime: 2021-08-26 20:24:18
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \h5_online_editor\src\constructor\widget\widget.js
 */
import { createNamespacedHelpers } from 'vuex'
import { baseCommandStrat, baseMenuList } from './command'
import store from '@/store'
import { merge, uniqueId } from 'lodash'

const { mapGetters, mapActions } = createNamespacedHelpers('poster')
...
export default class Widget {
  constructor (config) {
    const item = merge(defaultWidgetConfig(), config, {
